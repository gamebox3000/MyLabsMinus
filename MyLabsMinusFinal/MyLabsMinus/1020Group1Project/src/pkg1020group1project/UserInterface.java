...
public class UserInterface {
    ...
    static void login(){
        ...
        recordHistory = true;
        String prompt = "Please enter your username to login.";
        while(true){  
            String input = parseInput(prompt);
            if(UserData.contains(input)){
                currentUser = UserData.getUser(input);
                switch (UserData.getUserType(input)){
                    case "student":
                        studentMenu();
                        break;
                    case "parent":
    ...
    static void search(){
        ...
        recordHistory = true;
        String prompt = "What kind of users would you like to see?\n1. Students\n2. Parents\n3. Teachers\nOr menu to go back";
        String[] acceptable = {"1","2","3"};
        String needs = "Please enter 1, 2, or 3 for your respective choice";
        String input = parseInput(acceptable, prompt, needs);
        switch (input){
            case "1":
                System.out.println("Student list:\n"+UserData.listUser(false, true, false)+"\n");
                break;
            case "2":
                System.out.println("Parent List:\n"+UserData.listUser(true, false, false)+"\n");
                break;
            case "3":
                System.out.println("Teacher List:\n"+UserData.listUser(false, false, true)+"\n");
                break;
            case "menu":
                switch (UserData.getUserType(currentUser.getUserName())){
                    case "student":
                        studentMenu();
                        break;
                    case "parent":
    ...
    static void printReport(){
        ...
        recordHistory = true;
        String prompt = "Please enter in a username to see report, or type menu to go back";
