...
/**
 * The Message class is the superclass for all the message dialogues and handles default behavior.
...
public class Message {
     ...
     * @param needs //The pre-defined message that prints when the user inputs invalid input
    ...
    /**
     * The runOverride method is what all message subclasses implement to customize their output and behavior.
    ...
    /**
     * The printMessage method is what is called to print a message to the screen. It does four things: prints the prompt for user input, checks for a command inputed by the user by running the executeCommand method, executes message dialogue behavior by running the runOverride method, and runs the validation code if the user makes mistakes at any point in the process.
     * @throws IOException 
     */
    ...
    //Executes commands.
    /**
     * The executeCommand checks for a command entered by a user and executes one of the commands it implements if it is given as input.
     * @return Whether the user entered a command. Returned to the printMessage method.
     * @throws IOException 
     */
    ...
    /**
     * Sets the currentInput. Used by the input Scanner to feed the currentInput into the currentInput field.
     * @param newCurrentInput The new input supplied by the User to this dialogue.
     */
    ...
    /**
     * Returns the pre-defined validation-triggered message printed when the user enters invalid input.
    ...
    /**
     * Prints the needs String for the validation message. Used only when the user enters invalid input.
     */
